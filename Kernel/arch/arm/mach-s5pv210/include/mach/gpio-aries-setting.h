...
static unsigned int jupiter_gpio_table[][6] =
{
...
#if defined(CONFIG_LATIN_ARIES_TV)  // CYS_ 2010.03.18 Sleep current problem : HWREV_MODE -> INPUT & PULL_NONE
	{S5PV210_GPG3(6), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST}, 
#else
	...
	// GPJ2 ----------------------------------------------------------------------------------------------------------------
#if defined(CONFIG_LATIN_ARIES_TV)  // CYS_ 2010.03.18 Sleep current problem : HWREV_MODE -> INPUT & PULL_NONE
	{S5PV210_GPJ2(0), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST}, 
	{S5PV210_GPJ2(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST}, 
	{S5PV210_GPJ2(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST}, 
	{S5PV210_GPJ2(3), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE, S3C_GPIO_DRVSTR_1X, S3C_GPIO_SLEWRATE_FAST}, 
#else
...
static unsigned int jupiter_sleep_gpio_table[][3] =
{
...
#endif
#if defined(CONFIG_LATIN_ARIES_TV)  // DerekJi_ 2010.03.22 Sleep current problem : TSP_INT -> INPUT & PULL_DOWN
	{S5PV210_GPB(3),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_TSP_INT
	...
	{S5PV210_GPB(6),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//GPIO_BT_nRST
#else
	...
	// GPG3 -------------------------------------------------
#if defined(CONFIG_LATIN_ARIES_TV)  //HS.yi: Define the LATIN Sleep GPIO:2010.08.17 
	//{S5PV210_GPG3(0), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_UP},	//GPIO_ISDBT_RST -> move to ISDB_ON_sleep_gpio_table
	{S5PV210_GPG3(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},
	{S5PV210_GPG3(2), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},
...
#if defined(CONFIG_LATIN_ARIES_TV)  // CYS_ 2010.03.18 Sleep current problem : HWREV_MODE -> INPUT & PULL_NONE
	{S5PV210_GPG3(6), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_HWREV_MODE0	
#else
...
#if defined(CONFIG_LATIN_ARIES_TV)    // DerekJi_ 2010.03.28 Sleep current problem 
	{S5PV210_GPJ0(2), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_ISDBT_CLK
	{S5PV210_GPJ0(3), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_ ISDBT_SYNC
	{S5PV210_GPJ0(4), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_ ISDBT_DTEN
	{S5PV210_GPJ0(5), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_DOWN},	//GPIO_ ISDBT_DATA
	{S5PV210_GPJ0(6), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	// NC
	{S5PV210_GPJ0(7), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_CAM_MEGA_EN	
#else
	...
	// GPJ2 -------------------------------------------------
#if defined(CONFIG_LATIN_ARIES_TV)  // CYS_ 2010.03.18 Sleep current problem : HWREV_MODE -> INPUT & PULL_NONE
	{S5PV210_GPJ2(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_ HWREV_MODE1
	{S5PV210_GPJ2(1), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_ HWREV_MODE2
	{S5PV210_GPJ2(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_OLED_DET
	{S5PV210_GPJ2(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_ HWREV_MODE3
#else
	...
	//{S5PV210_GPJ3(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_ISDBT_PWR_EN -> move to ISDB_ON_sleep_gpio_table
#else
	{S5PV210_GPJ3(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//_3_GPIO_TOUCH_EN
...
#if defined(CONFIG_LATIN_ARIES_TV)  //HS.yi: Define the LATIN Sleep GPIO:2010.08.17 
	//{S5PV210_GPJ4(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//GPIO_I2C_SW -> move to ISDB_ON_sleep_gpio_table
#else
